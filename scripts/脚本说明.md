...
| ---- | ------------------------------------------------- | ---------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 脚本 | `scripts/compare_store_lock.py`                   | 2026-04-28 14:24 | 对比车系“上市后 N 天”锁单，新/老门店拆分；可选大区汇总与城市图                    | 输入：`schema/data_path.md`（订单分析必需；可选大区 TSV）+ `schema/business_definition.json`；输出：stdout 对比表/榜单 + 可选 `scripts/reports/*.html` |
